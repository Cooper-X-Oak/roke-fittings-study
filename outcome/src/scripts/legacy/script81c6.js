...
(function ($) {
  ...
  $ (function () {
    ...
    $('.catalog-section-item').on('click', function () {
      ...
      $.ajax({
        url: '/ztovalue/ajax/catalog.tabs.php',
        type: 'POST',
        data,
    ...
    $('.catalog-box-item-toggle').on('click', function () {
      ...
      $.ajax({
        url: '/ztovalue/ajax/catalog.element.modal.php',
        type: 'POST',
        data,
        beforeSend: function (jqXHR, settings) {
          // $('.catalog-section-item').removeClass('active');
    ...
    $('#RequestModalFile').on('change', function (e) {
      ...
      $.each(modal_files, function (key, value) {
        ...
        $.ajax({
          url: '/ztovalue/ajax/upload-file.php',
          type: 'POST',
          data: formData,
          dataType: 'json',
          cache: false,
    ...
    $('#RequestModalForm').on('submit', function (e) {
      ...
      $.ajax({
        url: '/ztovalue/ajax/request.modal.php',
        type: 'POST',
        data: data,
        beforeSend: function (jqXHR, settings) {
    ...
    $('#FeedbackForm').on('submit', function (e) {
      ...
      $.ajax({
        url: '/ztovalue/ajax/feedback.php',
        type: 'POST',
        data: data,
        beforeSend: function (jqXHR, settings) {
          btn.attr('disabled', true);
